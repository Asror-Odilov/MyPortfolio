    ...
    <Container>
        ...
        <Wrapper>
            <Title data-aos="zoom-in" data-aos-duration="1000">
                <span style={{color: '#008f77', marginRight: '0.5rem',}}>//</span>HTML & CSS</Title>
            <SkillsCon>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> 
        ...
        <Wrapper>
            <Title data-aos="zoom-in" data-aos-duration="1000"> 
                <span style={{color: '#008f77', marginRight: '0.5rem',}}>//</span>JavaScript</Title>
            <SkillsCon>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: 'teal', width: '250px' }}
                    /><Name>JavaScript</Name> </Skill>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: 'teal', width: '230px' }}
                    /><Name>React.js</Name> </Skill>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: 'teal', width: '200px' }}
        ...
        <Wrapper>
            ...
            <SkillsCon>
                ...
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: '#0961c5', width: '230px' }}
                    /><Name>FireBase</Name> </Skill>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: '#0961c5', width: '210px' }}
                    /><Name>Firgma</Name> </Skill>
                <Skill data-aos="zoom-in" data-aos-duration="1000"> <Char style={{ background: '#0961c5', width: '190px' }}
                    /><Name>Git</Name> </Skill>
